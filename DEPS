...
vars = {
  ...
  'dart_revision': '7fa990079a0a88a0a3947446fe7f9636dae03f1e',
...
deps = {
  'src': 'https://github.com/flutter/buildroot.git' + '@' + 'e63045d27d5c21272dfe84c5e83326d2a7aae253',
  ...
  'src/third_party/dart/third_party/pkg/dartdoc':
   Var('dart_git') + '/dartdoc.git@cf0685a2d1ce7b698a5e155448d337b86381318a',
  ...
  'src/buildtools/emsdk': {
   'url': Var('skia_git') + '/external/github.com/emscripten-core/emsdk.git' + '@' + 'b3ca5a4900fc69ad6653261cc8c362691380df38',
     ...
     'packages': [
       {
        ...
        'version': '1URI3xQBhJgDc_tpK9vO7ZX7PaeNwnQ6unN1yD63x1YC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'KG9Y2q6J-jXoOIgVnQ-vTk0H2YerfydtYfqdsg3f9FMC'
       }
     ],
