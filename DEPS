...
vars = {
  ...
  'skia_revision': 'a990ef91b3b54bab1a52ce3432ac0f0c82be246a',
  ...
  'dart_revision': '11886774fee1faae74744beeadccac4b1bd3264c',
...
deps = {
  ...
  'src/third_party/dart/third_party/devtools':
   {'packages': [{'package': 'dart/third_party/flutter/devtools', 'version': 'git_revision:2a707ca56c1a9d5eeef212c28c573548a051fdd2'}], 'dep_type': 'cipd'},
  ...
  'src/third_party/dart/tools/sdks':
   {'packages': [{'package': 'dart/dart-sdk/${{platform}}', 'version': 'version:2.16.2'}], 'dep_type': 'cipd'},
  ...
  'src/buildtools/emsdk': {
   'url': Var('skia_git') + '/external/github.com/emscripten-core/emsdk.git' + '@' + 'e23aac7d1c7d052048e68a0b5987ab99cd15cc6d',
     ...
     'packages': [
       {
        ...
        'version': 'mbPpHdT-i4fHGJ77A8i5i-4PkycYFJZtWYYdOzDD04sC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'pnlwVqOTTWHeLq3J6OESICgjMRcMfBxV3j8EEC0C4D8C'
       }
     ],
